...
class MockedSession(BaseSession):
    ...
    def get_request(self) -> Union[TelegramMethod[TelegramType], None]:
        if self.requests:
    ...
    async def make_request(
        ...
        self.check_response(bot=bot, method=method, status_code=response.error_code, content=response.model_dump_json())
